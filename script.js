const dictionary = {
  ru: {
    ...
    heroLead: 'БЦ, офисы, жилые комплексы, паркинги, промышленные объекты. 112 сотрудников, 31 объект на ежедневном обслуживании.',
  ...
  kz: {
    ...
    navWorks: 'Жұмыстар',
    navFacilities: 'Объектілер',
    navAbout: 'Біз туралы',
    navContact: 'Байланыс',
    heroTag: 'Астана · 2018 жылдан коммерциялық клининг',
    heroTitle: 'Бизнес және көп қабатты тұрғын үй кешендері үшін кәсіби клининг',
    heroLead: 'БО, кеңселер, тұрғын үй кешендері, паркингтер. 112 қызметкер, күнделікті 31 объект.',
    ctaContact: 'Бізбен байланысу',
    ctaFacilities: 'Біздің объектілер',
    heroPanelTop: 'күнделікті қызмет',
    heroPanelBottom: 'объект',
    statYears: 'жыл нарықта',
    statStaff: 'қызметкер',
    statFacilities: 'объект күнделікті',
    statStreets: 'м² көше',
    ...
    service1Title: 'БО және кеңселерді тазалау',
    ...
    service2Text: 'Кіреберістер, лифттер, паркингтер, аулалар және ортақ аймақтар. ОСИ мен ұзақ мерзімді шарттар.',
    service3Title: 'Паркингтерді тазалау',
    service3Text: 'Жерасты паркингтерді механикаландырылған жуу.',
    service4Title: 'Аумақты тазалау және көгалдандыру',
    service4Text: 'Сыпыру, қоқысты шығару, шөп алаңына күтім. Жыл бойы қызмет.',
    service5Title: 'Қар тазалау және көктайғаққа қарсы өңдеу',
    service5Text: 'Аулалардан, паркингтерден қарды жедел тазалау. Реагенттер. Маусымда 24/7.',
    service6Title: 'Өнеркәсіптік клининг',
    service6Text: 'Өнеркәсіптік объектілерді, қоймаларды, өндірістік үй-жайларды тазалау.',
    worksTag: 'Жұмыстар',
    worksTitle: 'Объектіде көрінетін тазалық',
    facilitiesTag: 'Объектілер',
    facilitiesTitle: 'Бизнес-орталықтар, ТК, паркингтер және аумақтар',
    ...
    proof2Text: 'Кез келген объектіге арналған заманауи арнайы техника.',
    ...
    contactLead: 'Бірнеше объектіге кешенді қызмет шартын талқылауға дайынбыз. ОСИ және басқарушы компаниялар үшін арнайы шарттар.',
    phoneLabel: 'Телефон / WhatsApp / Telegram',
    cityLabel: 'Қала',
  ...
  en: {
    ...
    heroLead: 'Business centers, offices, residential complexes, parking lots. 112 staff, 31 facilities served daily.',
...
document.querySelectorAll('.section, .stats, .contact').forEach((node) => {
