const dictionary = {
  ru: {
    ...
    heroLead: 'БЦ, офисы, жилые комплексы, паркинги, промышленные объекты. 112 сотрудников, 21 объект на ежедневном обслуживании.',
  ...
  kz: {
    ...
    heroLead: 'БО, кеңселер, тұрғын үй кешендері, паркингтер. 112 қызметкер, күнделікті 21 объект.',
  ...
  en: {
    ...
    heroLead: 'Business centers, offices, residential complexes, parking lots. 112 staff, 21 facilities served daily.',
